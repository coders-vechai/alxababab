...
while true; do
    ...
    kbred=`echo "\033[33;3m"`
    echo ""
    printf "${kbred} Please Enter ${slm}IPV6${kbred} bro. ${normal}"
    printf "${kbred} Write yours from above ipv6s ${normal}\n"
    printf "${bgred} Note: if not above, write your own ${normal}"
    echo ""
    printf "${slm} ------> ${normal}"
    read ipv6s
    case $ipv6s in
...
while true; do
    ...
    kbred=`echo "\033[33;3m"`
    echo ""
    printf "${kbred} 1) Normal Installation${normal}\n"
    printf "${bgred} 2) Sunucu.al, Plusweb, Contabo, Onlinesunucum ${normal}"
    echo ""
    printf "${slm} ------> ${normal}"
    read svr23
    case $svr23 in
...
while true; do
    ...
    kbred=`echo "\033[33;3m"`
    echo ""
    printf "${slm}*******${bgred} ${kbred} Type = 1 for TunnelBroker Installation. ${normal}\n"
    printf "${slm}*******${bgred} ${kbred} Type = 2 for Normal Installation.. ${normal}\n"
    echo ""
    printf "${bgred} ------> ${normal}"
    read tnlbrk
    case $tnlbrk in
...
while true; do
    ...
    kbred=`echo "\033[33;3m"`
    echo ""
    printf "${slm}*******${bgred} 1) ${kbred} Normal Setup ${normal}\n"
    ...
    read adetv2
    case $adetv2 in
        [1]* ) printf "${slm}*******${bgred} ${kbred} Enter the number of proxy${normal}\n";read adetv2 && sln384=$(echo "nopro"); break;;
        [2]* ) printf "${slm}*******${bgred} ${kbred} Enter the number of proxy${normal}\n";read adet && adetv2=$(echo "2000") && sln384=$(echo "yespro"); break;;
        * ) echo "Please press one Y or N.";;
    esac
done
...
while true; do
    ...
    kbred=`echo "\033[33;3m"`
    echo ""
    printf "${slm}*******${bgred} 1)${kbred} Random Encrypted ${normal}\n"
    printf "${slm}*******${bgred} 2)${kbred} create password ${normal}\n"
    printf "${slm}*******${bgred} 3)${kbred} no password${normal}\n"
    printf "${slm}*******${bgred} 4)${kbred} ip auth just specify ip ${normal}\n"
    echo ""
    printf "${bgred} ------> ${normal}"
    read srrct2
    case $srrct2 in
...
rnd_ip_block ()
{
    ...
    d=${array[$RANDOM%16]}
    f=${array[$RANDOM%16]}
    echo test$a$b$c$d$f$b$a >> /root/data4.txt
...
if [ $sv231 = "nopro9" ] ; then
if [[ $tepro = "$adrsv3" ]] ; then
printf "\n\n$fgred SUCCESS! Your Proxies Have Been Tested And Appear Active - Successful $normal\n"
else
printf "\n\n$slm ERROR! Your Proxies Are Not Appearing Active $normal\n"
fi
if [[ $srlrct2 = "proxy4" ]] ; then
